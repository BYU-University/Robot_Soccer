// Generated by gencpp from file hadead/Num.msg
// DO NOT EDIT!


#ifndef HADEAD_MESSAGE_NUM_H
#define HADEAD_MESSAGE_NUM_H
...
struct Num_
{
  ...
  typedef boost::shared_ptr< ::hadead::Num_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::hadead::Num_<ContainerAllocator> const> ConstPtr;

}; // struct Num_

typedef ::hadead::Num_<std::allocator<void> > Num;

typedef boost::shared_ptr< ::hadead::Num > NumPtr;
typedef boost::shared_ptr< ::hadead::Num const> NumConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::hadead::Num_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::hadead::Num_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'hadead': ['/home/odroid/catkin_ws/src/robot_soccer/msg'], 'std_msgs': ['/opt/ros/jade/share/std_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::hadead::Num_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::hadead::Num_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hadead::Num_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hadead::Num_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hadead::Num_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hadead::Num_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::hadead::Num_<ContainerAllocator> >
{
  ...
  static const char* value(const ::hadead::Num_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xad34ec599372090fULL;
  static const uint64_t static_value2 = 0xfe818e3fe887923dULL;
};

template<class ContainerAllocator>
struct DataType< ::hadead::Num_<ContainerAllocator> >
{
  static const char* value()
  {
    return "hadead/Num";
...
template<class ContainerAllocator>
struct Definition< ::hadead::Num_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::hadead::Num_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::hadead::Num_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::hadead::Num_<ContainerAllocator>& v)
  {
    s << indent << "home1_x: ";
