...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_soccer-msg:<Num> is deprecated: use robot_soccer-msg:Num instead.")))
...
(cl:defmethod t-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_soccer-msg:t-val is deprecated.  Use robot_soccer-msg:t instead.")
  (t m))

(cl:ensure-generic-function 'tsys-val :lambda-list '(m))
(cl:defmethod tsys-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_soccer-msg:tsys-val is deprecated.  Use robot_soccer-msg:tsys instead.")
  (tsys m))
