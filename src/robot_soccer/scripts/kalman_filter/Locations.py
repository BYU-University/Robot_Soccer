...
class Locations:
    ...
    def setLocationsFromMeasurement(self,data):
        ...
        self.home1_x, self.home1_y = self.robotCameraAngleCorrection(pixelToMeter(data.home1_x), pixelToMeter(data.home1_y))
        self.home1_theta = degreeToRadian(data.home1_theta)
