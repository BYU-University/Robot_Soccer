...
def goXYOmegaAccel(x,y,theta,time=1):
  ...
  SpeedAccelM1(0x80,int(abs(s1)/time),s1)
  SpeedAccelM2(0x80,int(abs(s2)/time),s2)
  SpeedAccelM1(0x81,int(abs(s3)/time),s3)
  s1_prev=s1
  s2_prev=s2
  s3_prev=s3
...
def smoothStop(v1_1,v2_1,v3_1,v1_2,v2_2,v3_2):
  ...
  SpeedAccelM1(0x80,abs(s1*3),s1)
  SpeedAccelM2(0x80,abs(s2*3),s2)
  SpeedAccelM1(0x81,abs(s3*3),s3)
  time.sleep(.5)
  SpeedAccelM1(0x80,abs(s1*3),0)
  SpeedAccelM2(0x80,abs(s2*3),0)
  SpeedAccelM1(0x81,abs(s3*3),0)
  time.sleep(.5)
...
def leftTurnMomentum():
  goXYOmegaAccel(1.0,0.0,0.0,1)
  time.sleep(2)
  goXYOmegaAccel(-3.0,-1.0,0.0,1)
  time.sleep(.25)
  goXYOmegaAccel(0.0,-1.0,0.0,.75)
  time.sleep(1)
  goXYOmegaAccel(0,0,0,1)


def leftTurn():
  goXYOmegaAccel(1.0,0.0,0.0,1)
  time.sleep(2)
  goXYOmegaAccel(0.0,-1.0,0.0,1)
  time.sleep(2)
  goXYOmegaAccel(0,0,0,1)
